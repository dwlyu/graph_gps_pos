...
# CMSC 35430 Final Project Repo: <br> Exploring Graph Transformers – From Core Architectures to Positional Encoding Strategies

Built upon the repository for [GRIT](https://github.com/LiamMa/GRIT) and [GraphGPS](https://github.com/rampasek/GraphGPS).
...
In this *GraphGPS* package they provide several positional/structural encodings and model choices, implementing the GPS recipe. GraphGPS is built using [PyG](https://www.pyg.org/) and [GraphGym from PyG2](https://pytorch-geometric.readthedocs.io/en/2.0.0/notes/graphgym.html).
...
## Running different positional embeddings on ZINC dataset
### Training
```bash
python main.py --cfg configs/SAN/zinc-SAN-rrwp-lape.yaml wandb.use True

python main.py --cfg configs/SAN/zinc-SAN-rwse-lape.yaml wandb.use True

python main.py --cfg configs/SAN/zinc-SAN-rwse.yaml wandb.use True
```

### Expected performance
Performance comparison between different positional encoding strategies:  
- Laplacian Positional Encoding (`LapPE`) [paper](https://arxiv.org/abs/2106.03893)  
- Random Walk Structural Encoding (`RWSE`) [paper](https://arxiv.org/abs/2110.07875)  
- Relational Random Walk Positional Encoding (`RRWP`) [paper](https://arxiv.org/abs/2305.17589)  

![Experiment-viz](./experiment.png)
...
### W&B logging
To use W&B logging, set `wandb.use True` and have a certain entity (In my code, `dongweilyu-The University of Chicago`) set-up in your W&B account (or change it to whatever else you like by setting `wandb.entity`).
<!-- 
